...
class cCategory_View extends StatefulWidget {
  const cCategory_View({Key? key}) : super(key: key);

  @override
  _cCategory_ViewState createState() => _cCategory_ViewState();
}

class _cCategory_ViewState extends State<cCategory_View> {
  final Stream<QuerySnapshot> _shopsStream = FirebaseFirestore.instance
      .collection('users')
      .where('category', isEqualTo: "ملابس")
